...
def validUTF8(data):
    ...
    for byte in data:
        ...
        # If there are negative remaining bytes, it means there are too many continuation bytes
        if remaining_bytes < 0:
            return False
    
    # If there are remaining bytes after iterating through all data, it means the data is incomplete
